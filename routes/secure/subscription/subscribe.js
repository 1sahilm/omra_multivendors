...
router.post("/payment-link",async (req,res)=>{
    ...
    const {email,mobile_no,name,
        link_id,
        Amount,currency,purpose}=req.body
        
    // var cfConfig = new CFConfig(CFEnvironment.PRODUCTION, "2022-01-01", "1304257938ebdc70844f8fe3d8524031", secret="");
    const  cfConfig = new CFConfig(CFEnvironment.PRODUCTION, "2022-01-01", "1304257938ebdc70844f8fe3d8524031", "f520b71b1f9a44535a6f6029c69f91cae30d6a5f");
    try {
