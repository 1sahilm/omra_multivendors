...
const sendEmail = async ({
  ...
  //   });
    ...
    const html = ({ description, phoneNumber, email, merchantId,merchantEmail }) => {
      ...
      <table width="100%" border="0" cellspacing="20" cellpadding="0" style="background: ${mainBackgroundColor}; max-width: 800px; margin: auto; border-radius: 10px;">
        <tr>
          <td align="center" style="padding: 10px 0px 0px 0px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: ${textColor};">
            Hello, <strong>${escapedEmail}</strong> </br> Please confirm your Email Verification.
          </td>
        </tr>
        <tr>
    ...
    const message = {
      from: "Elaundry Marketplace@noreply <Elaundry-Marketplace-official@gmail.com>",
      to: [merchantEmail,"leadenquiry@elaundry.co.in"],
      subject: "Elaundry Marketplace - Customer Request",
      html: html({ description, email, phoneNumber, merchantId,merchantEmail }),
    };
