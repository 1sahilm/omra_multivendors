...
const sendEmail = async ({
  ...
  //   });
    ...
    debug: true,
    auth: {
        user: "leadenquiry@elaundry.co.in",
        pass: "Marketplace@elaundry@" 
            ...
            <table width="100%" border="0" cellspacing="20" cellpadding="0" style="background: ${mainBackgroundColor}; max-width: 800px; margin: auto; border-radius: 10px;">
              <tr>
                <td align="center" style="padding: 10px 0px 0px 0px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: ${textColor};">
                  Hello, <strong>${merchant}</strong> </br> You have received new leads from ${escapedEmail}.
                </td>
              </tr>
              <tr>
                <td align="center" style="padding: 20px 0;">
                  ...
                  <tr > 
                  <th align="center" style="border-radius: 5px; " > Merchant Id:</th>
                  ...
                  <th align="center" style="border-radius: 5px; margin-left:20px" > Buyer Query:</th>
                    ...
                    <tr>
                      <td style=" border:1px solid black; padding:20px !important; border-radius:3px"  bgcolor="${buttonBackgroundColor}" >${merchantId}</td>
       ...
       case "subscription":
        ...
        <body style="background: ${backgroundColor};">
          ...
          <table width="100%" border="0" cellspacing="20" cellpadding="0" style="background: ${mainBackgroundColor}; max-width: 800px; margin: auto; border-radius: 10px;">
            <tr>
              <td align="center" style="padding: 10px 0px 0px 0px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: ${textColor};">
                Hello, <strong>${merchant}</strong> </br> Dear ${vendors_name}, Your Service ${plan} has been activated from ${start_date} to ${end_date}. Enjoy the Service! Regards, E-Laundry Marketplace. OMRA Solutions.
              </td>
            </tr>
    ...
    const message = {
      ...
      html: html({ description, email, phoneNumber,merchantEmail,type }),
    };
